<?php /* Smarty version Smarty-3.1.19, created on 2019-03-03 13:45:14
         compiled from "/var/www/html/test-prestashop/themes/default-bootstrap/order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:938442635c7bda6a34ce60-18067056%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64d5c061a203873863868f2cce11854393ca58d9' => 
    array (
      0 => '/var/www/html/test-prestashop/themes/default-bootstrap/order-steps.tpl',
      1 => 1541059272,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '938442635c7bda6a34ce60-18067056',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c7bda6a39e0d3_99012724',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c7bda6a39e0d3_99012724')) {function content_5c7bda6a39e0d3_99012724($_smarty_tpl) {?>
...
">
	...
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
		...
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['multi_shipping']->value) {?><?php echo "&multi-shipping=";?><?php echo (string)$_smarty_tpl->tpl_vars['multi_shipping']->value;?><?php }?><?php $_tmp57=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,((string)Smarty::$_smarty_vars['capture']['url_back'])."&step=2".$_tmp57), ENT_QUOTES, 'UTF-8', true);?>
">
